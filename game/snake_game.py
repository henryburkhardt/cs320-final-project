...
class SnakeGame:
    ...
    def snake_init(self):
        ...
        for i in range(3):
            ...
            # self.snake_dict[tuple(point)] = 1 # used for vision array
    ...
    def create_new_point(self, key):
        ...
        # self.snake_dict[tuple(new_point)] = 1
    ...
    def remove_last_point(self):
        ...
        # print(self.snake_dict)
        # print(self.snake)
        # del self.snake_dict[tuple(last_point)]
    ...
    def generate_vision_array(self):
        ...
        # up_cell = int((not self.run_into_wall(headX - 1, headY)) and (not (headX - 1, headY) in self.snake_dict))
        # down_cell = int((not self.run_into_wall(headX + 1, headY)) and (not (headX + 1, headY) in self.snake_dict))
        # left_cell = int((not self.run_into_wall(headX, headY - 1)) and (not (headX, headY - 1) in self.snake_dict))
        # right_cell = int((not self.run_into_wall(headX, headY + 1)) and (not (headX, headY + 1) in self.snake_dict))
